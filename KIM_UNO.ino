...
const byte theProgram[] PROGMEM = { 
    ...
    0xF8,0xD3,0xF8,0xDC,0xF8,0xC0,0xFC,0xBE,0xED,0x87,0xF9,0xDE,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00
 };

void loadProgram(uint16_t theLocation) {
    int index = 0;

    regMAR = theLocation;
    for (index = 0; index < sizeof(theProgram); index++) {
